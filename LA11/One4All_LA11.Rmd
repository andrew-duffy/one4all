...
I, Ahyo Falick, came up with the names Daxton and Adaline for the couple. I found these names by first combining the 2018 data set with the babynames given, then getting rid of ambiguous names and finally analyzing the slopes of each name to produce a trendy decision. To analyze the slopes of each name, I created two data frames: one for males and one for females. For each, I added three new columns that showed the slopes of each respective name from 1990 to 2010. I then found the difference in the slopes by subtracting the slope of 1990-2000 from the slope of 2000-2010 to make sure the name was on an upward trend. For my individual name plot, I created two geom_smooth plots that depicted both the proportion of people named Ahyo over time and the proportion of people with Ahy as their first three letters over time. While my name is quite uncommon, there is still an obvious trend upwards for people named Ahyo over time.
