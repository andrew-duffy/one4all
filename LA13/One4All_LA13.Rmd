...
#Subquestion: It is commonly known that most of the world's polution comes from Asia. Although that is true for polution of the ocean, is it also true for co2 emissons?
...
Now that we can reject the null hypothesis, we sould represent the difference as a positive number so it can be represented on the histogram for the permutation test. Therefore:
...
Now, we need to do perm_means test. For this, I will make my own since asia does not appear at the start of the tibble, meaning n_A will not be 1:n_A.
