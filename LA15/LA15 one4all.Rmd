...
author: Andrew Duffy, Braden Greibel, Luke Fanning, Ahyo Falick.
---
...
In order to answer this question we will use data from data.worldbank.org. An international financial institution, world bank offers loans and grants to less developed countries in order to encourage developement. Recently, the world bank has stated that its goal is the reduction of poverty. The data set is a very large selection of statistics with a domain of almost every country, worldwide. It ranges from years 1995-2019. we will focus on the Female HIV rate, Literacy and Life expectancy variables in answering our team question.
...
### Ahyo Reflection:
My 6 month goal at the beginning of the semester was to be in graduate school working on a master's degree. I still wish to pursue this goal and enroll in a graduate program, although I am still not sure in exactly what field. My 5 year goal was to have a steady income and be involved in an exciting career path. This goal is also still something I would like to keep reaching for. Although it is fairly vague at the moment, I think it is important to keep my options open. In this course I learned how to do all sorts of things with large sets of data. Learning the applications of R studio was confusing and stressful at times, but in the end I feel confident in my abilities to transform data into whatever I want. If I could give myself at the beginning of the semester it would be to stay on top of the R4DS readings in order to help my lab group out more in the TRATs. Doing the readings on time would also allow me to understand the material better and create more effective code. Additionally, I would tell myself to stop procrastinating to reduce my stress levels and not scare my lab group as much.
...
I, Ahyo Falick, purusued the question of whether unemployment had an affect on the HIV rates of females. In order to do this, I first had to clean and tidy the data in order to select only the variables I needed. I then created linear plots of the data I was going to analyze in order to get a better understanding of their trends across time. To do this, I created two plots: the first of the HIV rate with respect to time and the second of the unemployment rate with respect to time. Next, I graphed the two variabels against eachother to see if I could find any clear trends between the two. Finally, I ran a permutation correlation test to see if the null hypothesis could be rejected. When the data from the permutation test was plotted on a histogram, it became clear that while there was some correaltion between the two, more data was needed in order to prove the two are statistically significant.
